...
| Operators need a product-level view | The scoped Operations Center shows Ask quality, citation coverage, latency, queue health, and actionable failures without requiring Grafana |

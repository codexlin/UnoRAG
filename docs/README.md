...
| 角色 | 从这里开始 | 接下来读 | 目标 |
|---|---|---|---|
| 产品评估者 / 使用者 | [产品说明](./PRODUCT.md) | [当前状态](./STATUS.md)、[版本记录](../CHANGELOG.md) | 判断能力、边界与当前成熟度 |
| 部署者 / 运维人员 | [部署指南](./DEPLOYMENT.md) | [运维指南](./OPERATIONS.md)、[发布门禁](./RELEASE.md)、[当前证据](./evidence/) | 完成安装、升级、监控、备份和恢复 |
| 开发者 / 集成方 | [系统架构](./ARCHITECTURE.md) | [开发指南](./DEVELOPMENT.md)、[Knowledge API](./INTEGRATION.md)、[API v1 契约](./contracts/retrieve-ask-v1.md) | 理解边界并安全修改或接入 |
...
| 层级 | 内容 | 维护规则 |
|---|---|---|
| 当前事实 | `PRODUCT`、`STATUS`、`ARCHITECTURE`、部署、运维、开发和集成文档 | 行为变化时与代码同一 PR 更新 |
| 稳定契约 | [Retrieve / Ask v1](./contracts/retrieve-ask-v1.md) | 兼容性变化必须经过版本设计 |
| 长期决策 | [ADR](./adr/) | 已发布正文不重写；通过新 ADR 替代 |
| 验收证据 | [`evidence/`](./evidence/) | 只保留当前稳定版和仍有独立诊断价值的报告 |
| 专项参考 | 可观测性、Langfuse、混合检索和品牌规则 | 不自动成为产品承诺，以当前事实文档为准 |
...
- [可观测性架构](./design/observability.md)与 [Langfuse 接入](./LANGFUSE.md)
- [混合检索演进设计](./design/hybrid-retrieval.md)

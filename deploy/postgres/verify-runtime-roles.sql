...
BEGIN
	...
	IF NOT has_table_privilege('unorag_worker_login', 'app.jobs', 'SELECT,INSERT,UPDATE')
		...
		OR NOT has_table_privilege('unorag_worker_login', 'app.ask_run_stages', 'SELECT')
		OR NOT has_table_privilege('unorag_worker_login', 'app.job_stage_runs', 'SELECT')
		OR NOT has_table_privilege('unorag_worker_login', 'app.audit_logs', 'SELECT,INSERT')

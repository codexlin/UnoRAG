...
Chunk-profile / layout stress set for A/B eval. Positive and refusal golds live in
`golds.jsonl` and `negative-golds.jsonl`.
...
```bash
UNORAG_BASE_URL=http://127.0.0.1:8088 pnpm eval:live
```

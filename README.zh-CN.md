...
素材溯源、第三方通知、SBOM/provenance 与镜像签名已经完成；稳定版 [`v0.2.0`](https://github.com/codexlin/UnoRAG/releases/tag/v0.2.0)
在现有产品与供应链门禁上增加了跨页表、低对比扫描、引用精度、解析 Provider、审计和删除恢复门禁。

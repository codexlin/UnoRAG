...
素材溯源、第三方通知、SBOM/provenance 与镜像签名已经完成；稳定版 [`v0.1.1`](https://github.com/codexlin/UnoRAG/releases/tag/v0.1.1)
已发布并完成绑定最终提交的供应链、升级、产品与三轮真实文件质量验收。详见 [v0.1.1 验收报告](./docs/evidence/2026-09-09-v0.1.1-release-acceptance.md)、[ADR-0007](./docs/adr/0007-fully-open-source-product-and-services.md) 和
[开源发布准备审计](./docs/OPEN_SOURCE_READINESS.md)。
